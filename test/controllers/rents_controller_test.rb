...
class RentsControllerTest < ActionController::TestCase
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post :create, rent: { date: @rent.date, end_date: @rent.end_date, preview_date: @rent.preview_date, price: @rent.price }
    end
  ...
  test "should update rent" do
    patch :update, id: @rent, rent: { date: @rent.date, end_date: @rent.end_date, preview_date: @rent.preview_date, price: @rent.price }
    assert_redirected_to rent_path(assigns(:rent))
  end

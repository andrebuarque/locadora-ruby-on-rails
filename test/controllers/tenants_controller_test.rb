...
class TenantsControllerTest < ActionController::TestCase
  ...
  test "should create tenant" do
    assert_difference('Tenant.count') do
      post :create, tenant: { email: @tenant.email, name: @tenant.name, phone_number: @tenant.phone_number }
    end
  ...
  test "should update tenant" do
    patch :update, id: @tenant, tenant: { email: @tenant.email, name: @tenant.name, phone_number: @tenant.phone_number }
    assert_redirected_to tenant_path(assigns(:tenant))
  end
